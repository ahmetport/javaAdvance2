...
public class işlemler {
    ...
    public static class Islemler {
        public static final String W = "\u001B[37m";//renklendirme googledadık ordan aldık
        ...
        public static void girisPanel() {
            ...
            switch (secim) {
                case 1:
                    urunTanımla();
                    girisPanel();//RECURSİVE method çagırma
                    break;
                case 2:
                    miktarGuncelle();
                    girisPanel();
        ...
        private static void miktarGuncelle() {
            ...
            if (urunler.keySet().contains(arananId)) {
                ...
                urunler.get(arananId).setMiktar(guncelMiktar + urunler.get(arananId).getMiktar());//trick burda
        ...
        private static void urunTanımla() {
            Scanner scan = new Scanner(System.in);//İÇİNE bi tane scanner atarsak dummy gerek kalmıyor
            ...
            Urunler urun = new Urunler(urunIsim, uretici, miktar, birim, raf);//trick burda
            urunler.put(id, urun);
